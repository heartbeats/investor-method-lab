...
- run_id: `20260228_015727`
- started_at: `2026-02-28 01:57:27`
- with_real_data: `True`
- skip_tests: `False`
...
|---|---|---:|---:|
| `build_verified_investors` | ok | 0 | 0.61 |
| `generate_top20_pack_sample` | ok | 0 | 0.59 |
| `build_real_opportunities` | ok | 0 | 26.97 |
| `generate_top20_pack_real` | ok | 0 | 0.29 |
| `unit_tests` | ok | 0 | 0.32 |
