...
- run_id: `20260307_004518`
- started_at: `2026-03-07 00:45:18`
- with_real_data: `True`
- skip_tests: `False`
...
|---|---|---:|---:|
| `build_verified_investors` | ok | 0 | 0.05 |
| `generate_top20_pack_sample` | ok | 0 | 0.12 |
| `build_real_opportunities` | failed | 1 | 0.09 |
...
Traceback (most recent call last):
  File "/Users/lucas/projects/investor-method-lab/scripts/build_real_opportunities.py", line 20, in <module>
    import pandas as pd
