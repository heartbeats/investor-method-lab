...
- run_id: `20260307_013135`
- started_at: `2026-03-07 01:31:35`
- with_real_data: `True`
- skip_tests: `False`
...
| `generate_top20_pack_sample` | ok | 0 | 0.06 |
| `build_real_opportunities` | ok | 0 | 0.65 |
| `generate_top20_pack_real` | ok | 0 | 0.26 |
| `unit_tests` | ok | 0 | 0.21 |
