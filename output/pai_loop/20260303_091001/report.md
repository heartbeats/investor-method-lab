...
- run_id: `20260303_091001`
- started_at: `2026-03-03 09:10:01`
- with_real_data: `True`
- skip_tests: `False`
...
|---|---|---:|---:|
| `build_verified_investors` | ok | 0 | 0.23 |
| `generate_top20_pack_sample` | ok | 0 | 0.22 |
| `build_real_opportunities` | ok | 0 | 6.03 |
| `generate_top20_pack_real` | ok | 0 | 0.41 |
| `unit_tests` | ok | 0 | 2.52 |
