...
- run_id: `20260316_091000`
- started_at: `2026-03-16 09:10:00`
- with_real_data: `True`
- skip_tests: `False`
...
| `generate_top20_pack_sample` | ok | 0 | 0.20 |
| `build_real_opportunities` | ok | 0 | 256.31 |
| `generate_top20_pack_real` | ok | 0 | 1.31 |
| `unit_tests` | ok | 0 | 1.17 |
